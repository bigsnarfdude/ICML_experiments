...
Base (pretrained) models retain awareness--defense coupling (49.3\% recovery vs.\ 4.6\%), confirming RLHF as the causal factor; SAE-level replication on Llama~3.1 8B shows the same IT-vs-base pattern ($d = 1.51$ vs.\ $0.50$, $p = 0.001$ vs.\ $0.166$), demonstrating cross-family generality.
...
\citet{pan2023rewards} showed that RLHF can trade off ethical behavior for reward---our finding that RLHF installs cosmetic awareness without functional defense is a mechanistic instance of this broader pattern.
