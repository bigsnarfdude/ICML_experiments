...
\paragraph{Scale validation: Gemma 12B.}
Preliminary trials ($n=10$) on Gemma~3 12B confirm the pattern at intermediate scale: IT shows a moderate effect ($d = 0.62$, $p = .11$, underpowered at $n=10$), while the PT model shows a strong effect ($d = 1.35$, $p = .009$, 40\% Groot).
