...
All experiment scripts, raw JSON result files, logs, and plotting code will be released publicly upon de-anonymization, including the H100 artefacts underlying every number in this paper.
