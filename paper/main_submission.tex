...
\icmlauthor{Anonymous Author}{indep}
...
In a false-positive evaluation across 30 diverse benign prompts (general QA, coding, creative writing, non-BVP mathematics), task features are uniformly inactive (activation $= 0.0$, all 5 features, all 30 prompts), yielding FPR $= 0/30$ for cross-domain topics.
Within-domain, at a threshold of $\Delta_{\text{neutral}} - 2\sigma$, all 5 chaos prompts are detected (TPR $= 100\%$) with 0/5 neutral false positives.
This is a small-scale evaluation; reliable FPR/TPR curves on standard benchmarks (\eg ShareGPT) remain future work.
...
Defense evaluation is preliminary (30 benign prompts, 5 within-domain controls); reliable FPR/TPR curves on standard benchmarks remain future work.
